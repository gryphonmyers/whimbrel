...
export default ({window}) => {
    ...
    return class DomRouter extends Router {
        constructor({}={}) {
            super(...arguments);
            ...
            const routeTo = async (val, cb) => {
                ...
                const abortPromise = new Promise((r,reject) => abort = () => reject(new Error('Aborted')));
                    ...
                    set: val =>
                        routeTo(val, () => {
                            ...
                            if (url.hash) {
                                ...
                                let prev = [window.pageXOffset, window.pageYOffset];
                                location.hash = '';
